...
@test isapprox(decode(disc, 1, SAMPLE_UNIFORM_ZERO_BIN), 0.0)
@test !isapprox(decode(disc, 2, SAMPLE_UNIFORM_ZERO_BIN), 0.0)
@test !isapprox(decode(disc, 3, SAMPLE_UNIFORM_ZERO_BIN), 0.0)
